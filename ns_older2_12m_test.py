"""Untouched 2022-09 to 2023-09 validation for N-S momentum research."""

import sys
from app import ns_instability_older2_12m_selftest


def main():
    result = ns_instability_older2_12m_selftest()
    ...
    print("NS_RESEARCH_12M_OLDER2: OK", {
...
if __name__ == "__main__":
    try:
        ...
        print(f"NS_RESEARCH_12M_OLDER2 FAILED: {type(exc).__name__}: {exc}", file=sys.stderr)
        raise
