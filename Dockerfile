...
COPY app.py native_strategy.py market_data.py spatial_strategy.py spatial_ns_v8.py smoke_test.py ns_12m_test.py ns_prior_12m_test.py ns_older_12m_test.py ns_older2_12m_test.py ns_oldest_12m_test.py ns_v5_backfill_test.py ns_v5_holdout_test.py ns_v8_test.py ns_v8_prior_test.py ns_v8_reduced_smoke.py /app/
