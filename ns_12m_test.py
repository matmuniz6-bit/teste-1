"""Focused current 12-month validation for the N-S V4 detector."""
...
if __name__ == "__main__":
    try:
        ...
        print(f"NS_V4_12M_CURRENT FAILED: {type(exc).__name__}: {exc}", file=sys.stderr)
        raise
